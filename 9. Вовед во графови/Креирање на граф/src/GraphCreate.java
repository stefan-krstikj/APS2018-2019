    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i =0; i < n; i++){
            ...
            if(arg[0].equals("CREATE")){
                graph = new Graph<>(Integer.parseInt(arg[1]));
            }
            else if(arg[0].equals("ADDEDGE")){
                graph.addEdge(Integer.parseInt(arg[1]), Integer.parseInt(arg[2]));
            }
            else if(arg[0].equals("DELETEEDGE")){
                graph.deleteEdge(Integer.parseInt(arg[1]), Integer.parseInt(arg[2]));
            }
            else if(arg[0].equals("ADJACENT")){
                int x = Integer.parseInt(arg[1]);
                int y = Integer.parseInt(arg[2]);

                if(graph.adjacent(x, y) == 1)
                    System.out.println("1");
                else{
                    System.out.println("0");
                }
            }
            else if(arg[0].equals("PRINTMATRIX")){
                System.out.println(graph.print());
            }
            else if(arg[0].equals("PRINTNODE")){
                System.out.println(NumbToLetter((Integer.parseInt(arg[1]) + 65)));
            }
        }
    }

    public static String NumbToLetter(int x){
