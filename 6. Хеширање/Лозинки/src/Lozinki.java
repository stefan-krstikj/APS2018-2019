...
public class Lozinki {
    public static void main (String[] args) throws IOException {
        ...
        CBHT<String, String> table1 = new CBHT<String, String>(2*N);

        for(int i=1;i<=N;i++){
            String imelozinka = br.readLine();
            String[] pom = imelozinka.split(" ");
            table1.insert(pom[0], pom[1]);
        }

        String reader;
        while(!(reader = br.readLine()).equals("KRAJ")){
            String[] pom = reader.split(" ");
            SLLNode<MapEntry<String, String>> tmp = table1.search(pom[0]);
